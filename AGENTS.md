...
| Project | Path | Latest |
|---------|------|--------|
| **mecom_hmi_head** (현장 HMI) | `C:\project\opencode\mecom_hmi_head` | v1.2 — Ethernet/TCP 지원 |
| **mecom_head** (본사 서버) | `C:\project\opencode\mecom_head` | v1.0 |

현재 `mecom_hmi_head`에 집중 중. 자세한 작업 이력은
`mecom_hmi_head/AGENTS.md`의 Session Log 참고.
